    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_parent', models.CharField(blank=True, max_length=20, null=True, verbose_name='Code parent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banque', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='depense_feuilles', to='banques.banque', verbose_name='Banque')),
                ('service_beneficiaire', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='depense_feuilles', to='accounts.service', verbose_name='Service bénéficiaire')),
                ('nature_economique', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='depense_feuilles', to='demandes.natureeconomique', verbose_name='Article Littera')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('EN_ATTENTE', 'En attente'), ('VALIDEE_DG', 'Validée par le DG'), ('PAYEE', 'Payée'), ('REJETEE', 'Rejetée')], default='EN_ATTENTE', max_length=20)),
                ...
                ('nature_economique', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='demandes', to='demandes.natureeconomique', verbose_name='Article Littera')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_creation', models.DateTimeField(auto_now_add=True)),
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('banque', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='depenses', to='banques.banque', verbose_name='Banque')),
