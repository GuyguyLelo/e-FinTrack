...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                <nav class="nav flex-column">
                    ...
                    {% if user.role == 'DG' or user.role == 'DF' or user.role == 'CD_FINANCE' %}
                    <div class="menu-section">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var isSuperAdmin = "{{ user.is_super_admin }}" === "True";
            ...
            if ((isSuperAdmin || isSuperuser) && currentPath === '/demandes/natures/') {
            ...
            // DirDaf, DivDaf : tableau de bord
            if ((userRole === 'DG' || userRole === 'DF' || userRole === 'CD_FINANCE') && currentPath === '/') {
