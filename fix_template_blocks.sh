#!/bin/bash
# fix_template_blocks.sh - Correction des blocks de template

set -e

echo "🔧 Correction des Blocks de Template"
echo "================================="
...
echo "Cause: Conflit entre base.html et login.html"

echo ""
echo "🔧 2. Création d'un template base corrigé..."

cat > templates/base_fixed_final.html << 'BASE_TEMPLATE'
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
echo "✅ Template base_fixed_final.html créé"

echo ""
echo "🔧 3. Création d'un template login corrigé..."

cat > templates/accounts/login_fixed_final.html << 'LOGIN_TEMPLATE'
{% extends 'base.html' %}
{% load static %}
...
echo "✅ Template login_fixed_final.html créé"
...
cp templates/base_fixed_final.html templates/base.html
cp templates/accounts/login_fixed_final.html templates/accounts/login.html
...
echo ""
echo "🌐 6. Test des templates corrigés..."
...
echo ""
echo "✅ Correction des blocks terminée !"
